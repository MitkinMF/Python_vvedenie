...
def user_answer(s,db):
    db[2] = user_input((f"{s}, введите колчество конфет, которое хотите взять (от 1 до {db[5]}): "))
...
game_db[5] = user_input("Введите максимальное количеество конфет, которое можно взять за один ход: ")
select_game = int(input("Введите тип игры (1 - игрок против бота, 2 - игорок против игрока): "))
if select_game == 1:
    # выбор, кто ходит первым  0 -  бот , 1 - игрок1,  1 - игрок2
